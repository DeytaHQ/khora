...
- [`11_image_ingestion.py`](30_workloads/11_image_ingestion.py) — *skeleton* —
...
| **Skeleton** | Cost-efficient hybrid search; ~10% LLM extraction; long-form / large corpora | `00_quickstart/{01,03,04}`, `30_workloads/{09,11}` |
