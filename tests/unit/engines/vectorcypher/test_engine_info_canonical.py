...
Pins the ADR-098 §1 #24 contract for the canonical keys emitted by the
vectorcypher path (DYT-4601):
...
class TestEngineInfoCanonicalKeys:
    """ADR-098 §1 #24 canonical engine_info contract for vectorcypher recall."""
