...
class TestBaseBackendGetDocumentStats:
    ...
    async def test_default_delegates_to_individual_methods(self) -> None:
        ...
        class FakeRelational(RelationalBackendProtocol):
            ...
            async def claim_orphaned_documents(self, ns_id, **kw): ...
            async def update_document(self, doc): ...
            async def delete_document(self, doc_id): ...
            async def get_document_by_checksum(self, ns_id, checksum): ...
            async def get_documents_by_checksums(self, ns_id, checksums, *, pending_stale_before=None): ...
            async def get_document_by_external_id(self, external_id, *, namespace_id): ...
            async def get_documents_by_external_ids(self, external_ids, *, namespace_id): ...
