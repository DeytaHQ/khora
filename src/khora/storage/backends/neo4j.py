...
class Neo4jBackend(GraphBackendBase):
        ...
        *,
        ...
        _UPSERT_CYPHER = """
            ...
            ON MATCH SET
                ...
                e.attributes = row.attributes,
                e.source_tool = CASE WHEN size(row.source_tool) > 0 THEN row.source_tool ELSE coalesce(e.source_tool, '') END,
    ...
    def _record_to_entity(self, node: dict[str, Any]) -> Entity:
        ...
        return Entity(
            ...
            source_tool=node.get("source_tool", ""),
